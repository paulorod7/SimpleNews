...
import com.prss.simplenews.provider.FeedDataContentProvider;
...
public class RSSOverview extends ListActivity {	
	...
	static NotificationManager notificationManager; // start escopo
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (PreferenceManager.getDefaultSharedPreferences(this).getBoolean(Strings.SETTINGS_REFRESHENABLED, false)) {
        	startService(new Intent(this, RefreshService.class)); // inicia a activiy independente do service
        } 
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		// no icons, export is disabled for now
	...
	private Dialog createURLDialog(String title, String url, final String id) {
		...
		if (url != null) { // diferencia se é edicao.. ta bem porco eu sei.
